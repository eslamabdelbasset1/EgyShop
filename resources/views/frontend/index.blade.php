                                        ...
                                        <li class="yamm-content">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <h2 class="title"> @if(session()->get('language') == 'arabic'){{ $subcategory->subcategory_name_ar }}
                                                        ...
                                                        <div class="product-info text-left">
                                                            ...
                                                            @else
                                                                <div class="product-price"> <span class="price">
                                                                        {{ $product->discount_price }} EGY</span>
                                                        ...
                                                        <div class="product-info text-left">
                                                            ...
                                                            @else
                                                                <div class="product-price"> <span class="price"> {{ $product->discount_price }} EGY
                                                                    </span> <span class="price-before-discount"> {{ $product->selling_price }} EGY</span>
                                                                </div>
                                                            @endif
                                                            <!-- /.product-price -->
